...
def step1_build_and_simulate():
    section("ШАГ 1/4. [SIMULATOR] Реальные продажи + СИНТЕТИЧЕСКИЕ касания (bot/simulator.py)")
...
def step3_romi(revenue_by_model: dict):
    ...
    print("\n  ВАЖНАЯ ОГОВОРКА: стоимость канала здесь является сумма 4 условных размещений")
